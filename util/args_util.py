...
def get_args():
    ...
    parser.add_argument("--random_affine_odds", default=0.5, type=float, help="odds of random affine")
    parser.add_argument("--sv_augmentation", default=False, type=bool, help="sv augmentation")
